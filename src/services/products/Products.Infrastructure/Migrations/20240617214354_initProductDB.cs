        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationDateTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValue: new DateTime(2024, 6, 17, 21, 43, 54, 125, DateTimeKind.Utc).AddTicks(4905)),
                    ModificationDateTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValue: new DateTime(2024, 6, 17, 21, 43, 54, 125, DateTimeKind.Utc).AddTicks(5179))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationDateTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValue: new DateTime(2024, 6, 17, 21, 43, 54, 125, DateTimeKind.Utc).AddTicks(9099)),
                    ModificationDateTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValue: new DateTime(2024, 6, 17, 21, 43, 54, 125, DateTimeKind.Utc).AddTicks(9387))
                },
                constraints: table =>
                {
